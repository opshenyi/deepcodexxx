...
- Distribution preflight reports check the product root for required scripts, package build scripts, Desktop bootstrap safety, built artifacts, docs, and ignored local-state paths through shared core helpers, CLI, server API, and Web/Desktop.
