...
- `.deepcodex/config.json` can define repository defaults for model, policy profile, approval mode, max steps, budget, file policy additions, shell environment, pricing profile, and retention.
