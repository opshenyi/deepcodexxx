...
| Phase 2: product operations | Make demos repeatable and measurable. | Semantic eval scoring, cross-run comparison reports, benchmark task expansion, managed pricing profile evidence. | A release can compare behavior across model/config changes. |
