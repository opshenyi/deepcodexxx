...
| Policy bundle administration | Builds on key rotation/revocation primitives with signed bundle creation, distribution, and audit UI. | Provider config, clients. |
