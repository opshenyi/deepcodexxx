...
7. Load release evidence, distribution preflight, eval evidence, and security scan panels to show release signals, delivery checks, and preflight safety checks.
