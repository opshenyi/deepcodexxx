...
- Built-in read-only CLI smoke evals for repository mapping, safety review, and release-evidence review, with exact expected-signal scoring and CI threshold flags.
...
| Built-in evals | `docs/evals.md` | Repeatable read-only CLI smoke tasks, scoring behavior, CI thresholds, and current scoring limits. |
