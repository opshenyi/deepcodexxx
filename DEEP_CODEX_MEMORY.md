...
1. Commit and push the shell environment isolation work if it has not already been committed.
2. Add generated-asset policies and OS-level shell sandboxing.
